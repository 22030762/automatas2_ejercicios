...
def serializedATN():
    return [
        4,1,22,10,2,0,7,0,2,1,7,1,1,0,1,0,1,0,1,1,1,1,1,1,0,0,2,0,2,0,0,
...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'public'", "'class'", "'static'", "'void'", 
                     "'int'", "'if'", "'String'", "<INVALID>", "<INVALID>", 
                     "<INVALID>", "'='", "'+'", "'>='", "'.'", "';'", "'('", 
                     "')'", "'{'", "'}'", "'['", "']'" ]

    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "INT", "IF", "STRING", "NUM", "CADENA", "ID", "IGUAL", 
                      "MAS", "MAYOR_IGUAL", "PUNTO", "PUNTO_COMA", "PAR_IZQ", 
