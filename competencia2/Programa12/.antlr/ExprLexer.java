// Generated from d:/Descargas/automatas2_ejercicios/competencia2/Programa12/Expr.g4 by ANTLR 4.13.1
...
public class ExprLexer extends Lexer {
	...
	public static final int
		PUBLIC=1, CLASS=2, STATIC=3, VOID=4, INT=5, IF=6, STRING=7, NUM=8, CADENA=9, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PUBLIC", "CLASS", "STATIC", "VOID", "INT", "IF", "STRING", "NUM", "CADENA", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "PUBLIC", "CLASS", "STATIC", "VOID", "INT", "IF", "STRING", "NUM", 
